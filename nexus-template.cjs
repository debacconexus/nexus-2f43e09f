...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "University Student Services Case Management";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Student Service Case";
process.env.TABLE_NAME = process.env.TABLE_NAME || "student_service_case_records";
'use strict';
